...
<body>
			  ...
			  <div class="navbar-collapse collapse " style="color: white; margin-left: 100px" id="navb">
				    <ul class="navbar-nav mr-auto ">
				      <li class="nav-item active">
				        <a href="main.html" class="btn btn-outline-secondary " style="margin-left: 15px; color: white;">Home</a>
				      </li>
				      <li class="nav-item active">
		      ...
		      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
		        ...
		        <div class="carousel-inner">
		          <div class="carousel-item active">
		              <img class="d-block w-100" src="images/restaurent/cafe/cs1.jpg" alt="First slide" data-holder-rendered="true">
		          ...
		          <div class="carousel-item">
		            <img class="d-block w-100" src="images/restaurent/cafe/cs2.jpg" alt="Second slide" data-holder-rendered="true">
		              <div class="carousel-caption d-none d-md-block">
		          ...
		          <div class="carousel-item ">
		            <img class="d-block w-100" src="images/restaurent/cafe/cs3.jpg" alt="Third slide" data-holder-rendered="true">
		              <div class="carousel-caption d-none d-md-block">
	...
	<section id="about"> 
		<div class="container">
			<h1 class="aheader animated bounceIn ">Cafe Darbar</h1>
	...
	<section id="gld">
		<div class="collapse mappos container " id="glt">
				...
				<img class="row" src="images/restaurent/cafe/menu.jpg">
	...
	<section id="gldd">
		<div class="collapse mappos galley" id="gltt">
				<a href="images/restaurent/cafe/r1.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs1.png"></a>
				<a href="images/restaurent/cafe/r2.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs2.png"></a>
				<a href="images/restaurent/cafe/r3.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs3.png"></a>
				<a href="images/restaurent/cafe/r4.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs4.png"></a>
				<a href="images/restaurent/cafe/r5.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs5.png"></a>
				<a href="images/restaurent/cafe/r6.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs6.png"></a>
				<a href="images/restaurent/cafe/r7.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs7.png"></a>
				<a href="images/restaurent/cafe/r8.png" data-lightbox="mygallery"><img src="images/restaurent/cafe/rs8.png"></a>
					...
					<div class="hours content">
						<div class="detail row">
							<span class="day"><h5 class="t1">Sunday</h5></span>
								<span class="hours"><div class="tt1">11:00 AM - 10:30 PM</div></span>
						</div>
						<div class="detail row">
	...
	<div class=" container columns large-4">
                    ...
                    <div class="content__semi content__semi--adjust">
                        ...
                        <div class="content__semi__body">
                           <h4>House # 75, Ground Floor, Rd No 5/A, Dhaka 1209 </h4>
                        </div>
                    </div>

                    <div class="container-fluid">
                        <div class="image mmma">
                            <a href="https://www.google.com/maps/place/Cafe+Darbar/@23.7419308,90.3717062,17z/data=!3m1!4b1!4m5!3m4!1s0x3755bf4adf413a23:0x98c0b3f4e8236075!8m2!3d23.7419308!4d90.3738949Cafe+Darbar/@23.7419308,90.3717062,17zdata=!3m1!4b1!4m5!3m4!1s0x3755bf4adf413a23:0x98c0b3f4e8236075!8m2!3d23.7419308!4d90.3738949" 
                            alt=""></figure><img src="images/restaurent/cafe/map11.jpg" style="width: 320px; height: 320px;"></a>
                        </div>
                    </div>
    ...
    <section id="contact">
    	<div class="container">
    		...
    		<P><i class="fa fa-phone" id="phn"> +8801678</i></P>
