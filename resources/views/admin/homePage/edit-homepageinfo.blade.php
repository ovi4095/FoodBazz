    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="well">
                ...
                @endif
                <form name="edithomePageForm" class="form-horizontal" action="{{url('/homepage/update-homePageInfo')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-sm=3">Home page title</label>
                        <div class="col-sm-9">
                            <input type="text" value="{{$homepage->home_title}}"  name="home_title" class="form-control">
